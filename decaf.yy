...
variable_declarations:
    ...
    variable_declarations type variable_list ptSemicolon
    {
        $$ = $1;
        $$->push_back(new VariableDeclarationNode($2, $3));
    }
    |
    {
...
method_declaration:
    ...
    kwStatic method_return_type Identifier ptLParen parameters ptRParen
    ptLBrace
        variable_declarations
        statement_list
    ptRBrace
...
statement:
    ...
    variable OpAssign expression ptSemicolon
    {
